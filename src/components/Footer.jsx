...
const Footer = () => {
  return (
    <footer className="bg-[#0E2931] md:min-h-80 flex flex-col justify-center items-center  text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-8 mb-20  min-h-45">
          ...
          <div className="lg:pl-8">
            <h3 className=" font-black mb-8 uppercase tracking-widest text-[11px] text-green-400">Shop</h3>
          ...
          {/* Newsletter Section */}
          <div className="space-y-6">
            <h3 className="text-lg font-black mb-8 uppercase tracking-widest  text-[11px] text-green-400">Newsletter</h3>
            ...
            <div className="relative group">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 p-28 text-sm focus:outline-none h-8 focus:bg-white/10  focus:border-green-400/50 transition-all  font-medium"
              />
              <button className="absolute right-2 top-1 bottom-1 bg-green-400 text-[#0E2931] w-10 rounded-xl flex items-center justify-center h-6 hover:scale-105 transition-all shadow-lg shadow-green-400/20 active:scale-95">
                <Send size={16} />
              </button>
            </div>
          </div>
        ...
        {/* Contact Strip */}
        <div className="grid grid-cols-1 mt-8 md:grid-cols-3 gap-8 p-6 bg-white/5 rounded-3xl border border-white/10 mb-10 ">
