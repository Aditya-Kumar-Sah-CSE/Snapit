    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-gray-100">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-black text-[#0E2931]">Create Account</h2>
          <p className="mt-2 text-sm text-gray-500">
            Already have an account?{' '}
            <Link to="/login" className="font-bold text-[#0E2931] hover:underline">
              Log in
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6">
          ...
          <div className="flex items-center">
            ...
            <label className="ml-2 block text-sm text-gray-900 font-medium">
              I agree to the <a href="#" className="font-bold text-[#0E2931] hover:underline">Terms & Conditions</a>
            </label>
          </div>
