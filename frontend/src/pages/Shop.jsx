    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-16">
            ...
            <div className="bg-[#0E2931] text-white py-16 px-4 md:px-8">
                <div className="max-w-7xl mx-auto text-center flex justify-center items-center flex-col p-7">
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 py-10">
                ...
                <div className="flex flex-col items-center justify-center mb-10 gap-6 text-center">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <div className="relative flex-1 md:flex-none md:min-w-40 md:h-10">
                            <select
                                value={sortBy}
                                onChange={(e) => setSortBy(e.target.value)}
                                className="w-full appearance-none bg-white border border-gray-200 rounded-xl px-5 py-3 pr-20 text-sm font-bold text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#0E2931]/10 cursor-pointer shadow-sm min-h-8 "
                            >
                ...
                {filteredProducts.length > 0 ? (
                    <div className="product-grid grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-15">
